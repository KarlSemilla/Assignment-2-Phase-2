...
public class Item
{
    ...
    public Item(String num, String name, int stock, double price, int reorder, int eoq)
    {
        itemNo = num;
        itemName = name;
        onHand = stock;
    ...
    public Item(String num, String name, int stock, int reserved, int order,  double price, int reorder, int eoq)
    {
        itemNo = num;
        itemName = name;
        onHand = stock;
